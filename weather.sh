...
# Keep only the last 10 JSON files in the directory if there are 11 or more (optional)
...
# Keep only the last 10 timestamps in the directory if there are 11 or more (optional)
